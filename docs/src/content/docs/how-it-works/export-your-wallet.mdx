...
tags: ["How it Works", "Wallet", "Withdraw", "Self-Custody"]
---

To move funds off Axal, withdraw your funds by exporting your Privy smart wallet to a self‑custody wallet such as MetaMask (EVM) or Phantom (Solana):
