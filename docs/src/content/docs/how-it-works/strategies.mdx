...
|------|------|--------------|
| Morpho Gauntlet USDC Vault | Vault | 30% |
| Morpho Seamless USDC Vault | Vault | 20% |
| Morpho Moonwell USDC Vault | Vault | 20% |
| Spark USDC Vault | Vault | 15% |
| YO USDC Vault | Vault | 15% |
