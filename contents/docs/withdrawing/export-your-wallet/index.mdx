...
tags: ["Wallet", "Withdrawal", "Self-Custody"]
---

To move funds off Axal entirely, export your Privy smart wallet to a self‑custody wallet such as MetaMask (EVM) or Phantom (Solana):
...
2. Fill in your authentication code from your authenticator app.
